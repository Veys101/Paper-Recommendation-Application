...
The project was written by Python. The aim of Paper Recommendation application is to recommend related paper to users. The web platform is called ESOGU Paper and it provides service like access papers, recommend related to that paper etc. For more details, browse ESOGU Paper folder.
