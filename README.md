...
The project was written by Python.The aim of Paper Recommendation application is to recommend related paper to users. The web platform is called ESOGU Paper. It provides service to access papers and recommend related to that paper. For more details, browse ESOGU Paper folder.
